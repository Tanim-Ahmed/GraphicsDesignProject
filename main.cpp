...
float eyex=0,eyey=0,eyez=10,cdx=0,cdy=0,cdz=0,hdx=0,hdy=1,hdz=0;
float angle=0.0;
int check=0;
float winW,winH;


const GLfloat light_ambient[]  = { .2f, .2f, .2f, 1.0f };
...
//kochhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh
int Depth=1;
...
GLfloat mat_ambient[]    = { .1f, .1f, .1f, 1.0f };
...
////////////////////second porton///////////////////////
    ...
    mat_ambient[0]=.1,mat_ambient[1]=.1,mat_ambient[2]=.1,mat_ambient[3]=1.0f;
...
///////////
    ...
    mat_ambient[0]=.2,mat_ambient[1]=.2,mat_ambient[2]=.2,mat_ambient[3]=1.0f;
...
void envi()
{
    ///if check==1 mane jodi textuer na thake tobe color bosabe na hole white color dibe
        GLfloat mat_ambient[]    = { .1f, .1f, .1f, 1.0f };
    ...
    if(check==0){
        ...
        glPushMatrix();
    mat_ambient[0]=.1,mat_ambient[1]=.1,mat_ambient[2]=.1,mat_ambient[3]=1.0f;
    mat_diffuse[0]=0.0,mat_diffuse[1]=0.0,mat_diffuse[2]=1.0,mat_diffuse[3]=1.0f;
...
if(check==0){
    ...
    mat_ambient[0]=.1,mat_ambient[1]=.1,mat_ambient[2]=.1,mat_ambient[3]=1.0f;
    mat_diffuse[0]=1,mat_diffuse[1]=0.0,mat_diffuse[2]=.30,mat_diffuse[3]=1.0f;
...
///Table up
    ...
    mat_ambient[0]=.1,mat_ambient[1]=.1,mat_ambient[2]=.1,mat_ambient[3]=1.0f;
    mat_diffuse[0]=0.0,mat_diffuse[1]=1.0,mat_diffuse[2]=0.0,mat_diffuse[3]=1.0f;
...
//ROTATION FOR X Y Z Q W E
//EYE POSITION CHANGING A S D
//CENTER POSITION CHANGING  D F G
//HEAD POSIION CHANGING H K L
...
void for_tex(){
    ...
    if(check==0){
        pix[2].readBMPFile("C:\\Users\\Tanim Ahmed\\Desktop\\Graphics_Final_Project\\walls.bmp"); ///ehhane image er path ta dibi
        pix[2].setTexture(3,1);
        pix[3].readBMPFile("C:\\Users\\Tanim Ahmed\\Desktop\\Graphics_Final_Project\\wood.bmp"); ///ehhane image er path ta dibi
        pix[3].setTexture(4,1);
        pix[4].readBMPFile("C:\\Users\\Tanim Ahmed\\Desktop\\Graphics_Final_Project\\wood.bmp"); ///ehhane image er path ta dibi
...
{
    printf("+ and - for zooming\n");
    printf("use 1 for depth increase and 2 for decrease\n");
    printf("Enter for roll: z  pitch: x  and yaw:c\n");
    printf("Enter m for camera rotation\n");
    printf("X,Y Z W Q for rotation\n");
    printf("A S D for eye\n");
    printf("D F G for center\n");
    printf("H K L for head\n");
